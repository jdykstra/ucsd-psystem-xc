...
TEST_SUBJECT="non-local return value"
. test_prelude

cat > example.text << 'fubar'
program nauseating;

  function hideous: integer;
...
; ----- -----  --------  -------- --- --------- --------
;     1    76  NAUSEATI  LINKED     1 P-Code LE 3.0
;
; Procedure 3:
****: 01                p3_0:   SLDC    1
****: B8 01 01                  STR     1, 1
...
;
****: 32 00                     .word   $ - p3_at       ; procedure 3
****: 26 00                     .word   $ - p2_at       ; procedure 2
