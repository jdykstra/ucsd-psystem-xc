...
TEST_SUBJECT="sind-ld optimization"
. test_prelude

cat > example.text << 'fubar'
program example;
type
  exrec = record a:integer; b: boolean end;

var
  eg: exrec;

  procedure mumble(var x: exrec);
  begin
    if x.b then writeln('foo')
  end;
