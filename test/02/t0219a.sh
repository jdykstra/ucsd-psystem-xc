...
program example;
  ...
  segment procedure userprog(dummy1, dummy2: integer);
  begin
    writeln(output, 'junk');
  end;
...
; ----- -----  --------  -------- --- --------- --------
;     2    16  EXAMPLE   LINKED     0 Undefined Pre-II.1
;
; Procedure 1:
****: D6                p1_0:   XIT
****: D7                        NOP
...
; Addr  Leng   Name      Kind     Num Type      Version
; ----- -----  --------  -------- --- --------- --------
;     1    36  USERPROG  LINKED     1 P-Code LE 3.0
;
; Procedure 1:
****: B6 01 03          p1_0:   LOD     1, 3
****: A6 04 6A 75 6E            LSA     4, "junk"
      6B
****: 00                        SLDC    0
