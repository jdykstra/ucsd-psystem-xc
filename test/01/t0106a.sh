...
TEST_SUBJECT="writeln()"
. test_prelude

#
# This is a grammar extension.
# You can call writeln with no parameters
# with an empty set of parens.
#
cat > test.text << 'fubar'
(*$warning error*)
(*$warning empty-parentheses false*)
program test_more;
begin
    writeln()
end.
...
; ----- -----  --------  -------- --- --------- --------
;     1    24  TESTMORE  LINKED     1 P-Code LE 3.0
;
; Procedure 1:
