...
TEST_SUBJECT="compile negate expressions"
. test_prelude
...
; ----- -----  --------  -------- --- --------- --------
;     1    56  NUMBERS   LINKED     1 P-Code LE 3.0
;
; Procedure 1:
...
$bindir/ucsdpsys_compile -o numbers.code numbers.pas
test $? -eq 0 || fail

$bindir/ucsdpsys_disassemble -a numbers.code > test.out
test $? -eq 0 || fail
