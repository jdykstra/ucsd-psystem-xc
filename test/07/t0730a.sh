...
TEST_SUBJECT="ucsdpsys_osmakgen vs man pages"
. test_prelude
...
#
# The $(mandir) is where to put the on-line manuals.  On a network, this would
...
# structure.
#
filenames = man/man1/blahblah.1

$(mandir)/man1/blahblah.1: man/man1/blahblah.1
{TAB}@mkdir -p $(mandir)/man1
{TAB}cp man/man1/blahblah.1 $(mandir)/man1/blahblah.1
...
distclean: clean dist-clean-files
dist-clean-files:
...
install: stage1.install $(mandir)/man1/blahblah.1
...
uninstall:
{TAB}rm -f $(mandir)/man1/blahblah.1
fubar
test $? -eq 0 || no_result

ucsdpsys_osmakgen man/man1/blahblah.1
test $? -eq 0 || fail
