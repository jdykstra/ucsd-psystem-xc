...
TEST_SUBJECT="ucsdpsys_osmakgen"
. test_prelude

TAB=`awk 'BEGIN{printf("%c",9)}' /dev/null`

mkdir compiler diagnostic librarian linker system
test $? -eq 0 || no_result

touch compiler/main.text diagnostic/main.text librarian/main.text \
    linker/main.text system/main.text
test $? -eq 0 || no_result
...
# structure.
#
filenames = compiler/main.text diagnostic/main.text librarian/main.text \
{TAB}{TAB}linker/main.text system/main.text
...
stage1/$(host)/codefiles/diagnostic/main.code: diagnostic/main.text
{TAB}@mkdir -p stage1/$(host)/codefiles/diagnostic
{TAB}ucsdpsys_compile $(XCFLAGS) -Idiagnostic -o \
{TAB}{TAB}stage1/$(host)/codefiles/diagnostic/main.code \
{TAB}{TAB}diagnostic/main.text

stage1/$(host)/codefiles/librarian/main.code: librarian/main.text
{TAB}@mkdir -p stage1/$(host)/codefiles/librarian
{TAB}ucsdpsys_compile $(XCFLAGS) -fignore-undefined-segment-zero \
{TAB}{TAB}-Ilibrarian -o stage1/$(host)/codefiles/librarian/main.code \
{TAB}{TAB}librarian/main.text
{TAB}ucsdpsys_librarian --file=stage1/$(host)/codefiles/librarian/main.code \
{TAB}{TAB}--remove-system-segments

stage1/$(host)/codefiles/linker/main.code: linker/main.text
{TAB}@mkdir -p stage1/$(host)/codefiles/linker
{TAB}ucsdpsys_compile $(XCFLAGS) -fignore-undefined-segment-zero -Ilinker \
{TAB}{TAB}-o stage1/$(host)/codefiles/linker/main.code linker/main.text
{TAB}ucsdpsys_librarian --file=stage1/$(host)/codefiles/linker/main.code \
{TAB}{TAB}--remove-system-segments
...
{TAB}ucsdpsys_mkfs --arch=$(arch) -B256 --label=diagnostic \
{TAB}{TAB}stage1/$(host)/diagnostic.vol
{TAB}ucsdpsys_disk -f stage1/$(host)/diagnostic.vol --put \
{TAB}{TAB}stage1/$(host)/diagnostic/system.pascal
{TAB}ucsdpsys_disk -f stage1/$(host)/diagnostic.vol --crunch --list \
{TAB}{TAB}--sort=name
...
{TAB}@mkdir -p stage1/$(host)/system
{TAB}cp stage1/$(host)/codefiles/linker/main.code \
{TAB}{TAB}stage1/$(host)/system/system.linker
...
{TAB}@mkdir -p stage2/$(host)/system
{TAB}cp stage2/$(host)/codefiles/linker/main.code \
{TAB}{TAB}stage2/$(host)/system/system.linker
...
{TAB}@mkdir -p stage3/$(host)/system
{TAB}cp stage3/$(host)/codefiles/linker/main.code \
{TAB}{TAB}stage3/$(host)/system/system.linker
...
{TAB}{TAB}stage1/$(host)/codefiles/librarian/main.code
{TAB}@mkdir -p stage1/$(host)/utility
{TAB}cp stage1/$(host)/codefiles/librarian/main.code \
{TAB}{TAB}stage1/$(host)/utility/librarian.code
...
stage1/$(host)/utility.vol: stage1/$(host)/utility/librarian.code
{TAB}@mkdir -p stage1/$(host)
{TAB}ucsdpsys_mkfs --arch=$(arch) -B256 --label=utility \
{TAB}{TAB}stage1/$(host)/utility.vol
{TAB}ucsdpsys_disk --file stage1/$(host)/utility.vol --text --put \
{TAB}{TAB}stage1/$(host)/utility/librarian.code
{TAB}ucsdpsys_disk --file stage1/$(host)/utility.vol --crunch --list \
{TAB}{TAB}--sort=name

stage2/$(host)/utility/librarian.code: \
{TAB}{TAB}stage2/$(host)/codefiles/librarian/main.code
{TAB}@mkdir -p stage2/$(host)/utility
{TAB}cp stage2/$(host)/codefiles/librarian/main.code \
{TAB}{TAB}stage2/$(host)/utility/librarian.code
...
stage2/$(host)/utility.vol: stage2/$(host)/utility/librarian.code
{TAB}@mkdir -p stage2/$(host)
{TAB}ucsdpsys_mkfs --arch=$(arch) -B256 --label=utility \
{TAB}{TAB}stage2/$(host)/utility.vol
{TAB}ucsdpsys_disk --file stage2/$(host)/utility.vol --text --put \
{TAB}{TAB}stage2/$(host)/utility/librarian.code
{TAB}ucsdpsys_disk --file stage2/$(host)/utility.vol --crunch --list \
{TAB}{TAB}--sort=name

stage3/$(host)/utility/librarian.code: \
{TAB}{TAB}stage3/$(host)/codefiles/librarian/main.code
{TAB}@mkdir -p stage3/$(host)/utility
{TAB}cp stage3/$(host)/codefiles/librarian/main.code \
{TAB}{TAB}stage3/$(host)/utility/librarian.code
...
stage3/$(host)/utility.vol: stage3/$(host)/utility/librarian.code
{TAB}@mkdir -p stage3/$(host)
{TAB}ucsdpsys_mkfs --arch=$(arch) -B256 --label=utility \
{TAB}{TAB}stage3/$(host)/utility.vol
{TAB}ucsdpsys_disk --file stage3/$(host)/utility.vol --text --put \
{TAB}{TAB}stage3/$(host)/utility/librarian.code
{TAB}ucsdpsys_disk --file stage3/$(host)/utility.vol --crunch --list \
{TAB}{TAB}--sort=name

clean: clean-files
clean-files:
{TAB}rm -f stage1/$(host)/codefiles/compiler/main.code
{TAB}rm -f stage1/$(host)/codefiles/diagnostic/main.code
{TAB}rm -f stage1/$(host)/codefiles/librarian/main.code
{TAB}rm -f stage1/$(host)/codefiles/linker/main.code
{TAB}rm -f stage1/$(host)/codefiles/system/main.code
{TAB}rm -f stage1/$(host)/diagnostic.vol
{TAB}rm -f stage1/$(host)/diagnostic/system.pascal stage1/$(host)/system.vol
{TAB}rm -f stage1/$(host)/system/system.compiler
{TAB}rm -f stage1/$(host)/system/system.linker
{TAB}rm -f stage1/$(host)/system/system.pascal stage1/$(host)/utility.vol
{TAB}rm -f stage1/$(host)/utility/librarian.code stage2/$(host)/system.vol
{TAB}rm -f stage2/$(host)/system/system.compiler
{TAB}rm -f stage2/$(host)/system/system.linker
{TAB}rm -f stage2/$(host)/system/system.pascal stage2/$(host)/utility.vol
{TAB}rm -f stage2/$(host)/utility/librarian.code stage3/$(host)/system.vol
{TAB}rm -f stage3/$(host)/system/system.compiler
{TAB}rm -f stage3/$(host)/system/system.linker
{TAB}rm -f stage3/$(host)/system/system.pascal stage3/$(host)/utility.vol
{TAB}rm -f stage3/$(host)/utility/librarian.code
...
ucsdpsys_osmakgen -o test.makefile system/main.text diagnostic/main.text \
        compiler/main.text linker/main.text librarian/main.text
test $? -eq 0 || fail

diff ok test.makefile
test $? -eq 0 || fail
