...
{TAB}{TAB}pascalio/main.text
{TAB}@mkdir -p stage1/$(host)/codefiles/pascalio
{TAB}ucsdpsys_compile $(XCFLAGS) -fignore-undefined-segment-zero -Ipascalio \
{TAB}{TAB}-o stage1/$(host)/codefiles/pascalio/main.code \
{TAB}{TAB}pascalio/main.text
{TAB}ucsdpsys_librarian --file=stage1/$(host)/codefiles/pascalio/main.code \
{TAB}{TAB}--remove-system-segments

pascalio/globals.text: system/globals.text
{TAB}@mkdir -p pascalio
{TAB}cp system/globals.text pascalio/globals.text
...
{TAB}{TAB}stage1/$(host)/codefiles/pascalio/main.code
{TAB}@mkdir -p stage1/$(host)/system
{TAB}ucsdpsys_librarian --create=stage1/$(host)/system/system.library \
{TAB}{TAB}--copy stage1/$(host)/codefiles/pascalio/main.code --segment \
{TAB}{TAB}pascalio=31
...
{TAB}{TAB}stage1/$(host)/system/system.library \
{TAB}{TAB}stage1/$(host)/system/system.pascal
...
{TAB}{TAB}stage2/$(host)/system/system.library \
{TAB}{TAB}stage2/$(host)/system/system.pascal
...
{TAB}{TAB}stage3/$(host)/system/system.library \
{TAB}{TAB}stage3/$(host)/system/system.pascal
...
clean: clean-files
clean-files:
{TAB}rm -f pascalio/globals.text stage1/$(host)/codefiles/pascalio/main.code
{TAB}rm -f stage1/$(host)/codefiles/system/main.code
{TAB}rm -f stage1/$(host)/system.vol stage1/$(host)/system/system.library
{TAB}rm -f stage1/$(host)/system/system.pascal stage2/$(host)/system.vol
{TAB}rm -f stage2/$(host)/system/system.pascal stage3/$(host)/system.vol
...
ucsdpsys_osmakgen -o test.makefile.out --no-blurb system/globals.text \
