...
TEST_SUBJECT="ucsdpsys_osmakgen vs miscinfo"
. test_prelude

mkdir -p host/klebsch system
test $? -eq 0 || no_result

touch host/klebsch/miscinfo.text system/main.text
test $? -eq 0 || no_result
...
filenames = host/klebsch/miscinfo.text system/main.text
...
stage1/$(host)/system.vol: $(stage1_system_miscinfo) \
{TAB}{TAB}stage1/$(host)/system/system.pascal
...
{TAB}{TAB}$(stage1_system_miscinfo) stage1/$(host)/system/system.pascal
...
stage2/$(host)/system.vol: $(stage2_system_miscinfo) \
{TAB}{TAB}stage2/$(host)/system/system.pascal
{TAB}@mkdir -p stage2/$(host)
{TAB}ucsdpsys_mkfs --arch=$(arch) -B256 --label=system \
{TAB}{TAB}stage2/$(host)/system.vol
{TAB}ucsdpsys_disk --file stage2/$(host)/system.vol --text --put \
{TAB}{TAB}$(stage2_system_miscinfo) stage2/$(host)/system/system.pascal
...
stage3/$(host)/system.vol: $(stage3_system_miscinfo) \
{TAB}{TAB}stage3/$(host)/system/system.pascal
{TAB}@mkdir -p stage3/$(host)
{TAB}ucsdpsys_mkfs --arch=$(arch) -B256 --label=system \
{TAB}{TAB}stage3/$(host)/system.vol
{TAB}ucsdpsys_disk --file stage3/$(host)/system.vol --text --put \
{TAB}{TAB}$(stage3_system_miscinfo) stage3/$(host)/system/system.pascal
...
{TAB}rm -f stage1/$(host)/system.vol stage1/$(host)/system/system.miscinfo
{TAB}rm -f stage1/$(host)/system/system.pascal
{TAB}rm -f stage2/$(host)/codefiles/host/klebsch/miscinfo.data
{TAB}rm -f stage2/$(host)/system.vol stage2/$(host)/system/system.miscinfo
{TAB}rm -f stage2/$(host)/system/system.pascal
{TAB}rm -f stage3/$(host)/codefiles/host/klebsch/miscinfo.data
{TAB}rm -f stage3/$(host)/system.vol stage3/$(host)/system/system.miscinfo
...
ucsdpsys_osmakgen -o test.makefile.out -b system/main.text \
