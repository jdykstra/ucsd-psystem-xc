...
/**
  * The symbol_function_littoral class is used to represent a callable
  * function symbol.  It exists to host the function call factory which
  * generates our littoral printable function call expression nodes.
  */
class symbol_function_littoral:
    public symbol_function
{
public:
    typedef boost::shared_ptr<symbol_function_littoral> pointer;

    /**
      * The destructor.
      */
    virtual ~symbol_function_littoral();
...
private:
    /**
      ...
      */
    symbol_function_littoral(const rcstring &name, const scope::pointer &locals,
        int lex_level, bool seg_proc, translator_littoral *cntxt);
    ...
    /**
      ...
      *     The translation context we are working within.
      */
    symbol_function_littoral(const rcstring &name, const location &dec_loc,
...
private:
    ...
    /**
      ...
      */
    symbol_function_littoral();

    /**
      * The copy constructor.  Do not use.
      */
    symbol_function_littoral(const symbol_function_littoral &);

    /**
      * The assignment operator.  Do not use.
      */
    symbol_function_littoral &operator=(const symbol_function_littoral &);
};
