...
/**
  * The expression_real_littoral class is used to represent
  * a real constant expression node littoral printer.
  */
class expression_real_littoral:
    public expression_real
{
public:
    typedef boost::shared_ptr<expression_real_littoral> pointer;

    /**
      * The destructor.
      */
    virtual ~expression_real_littoral();

private:
    /**
      * The constructor.
      */
    expression_real_littoral(const location &locn, const rcstring &value,
...
private:
    ...
    /**
      ...
      */
    expression_real_littoral();

    /**
      * The copy constructor.  Do not use.
      */
    expression_real_littoral(const expression_real_littoral &);

    /**
      * The assignment operator.  Do not use.
      */
    expression_real_littoral &operator=(const expression_real_littoral &);
};
