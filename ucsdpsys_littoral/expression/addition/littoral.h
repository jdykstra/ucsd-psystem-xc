...
/**
  * The expression_addition_littoral class is used to represent the littoral
  * printing of an addition expression node.
  */
class expression_addition_littoral:
    public expression_addition
{
public:
    typedef boost::shared_ptr<expression_addition_littoral> pointer;

    /**
      * The destructor.
      */
    virtual ~expression_addition_littoral();

private:
    /**
      * The constructor.
      */
    expression_addition_littoral(const expression::pointer &lhs,
...
private:
    ...
    /**
      ...
      */
    expression_addition_littoral();

    /**
      * The copy constructor.  Do not use.
      */
    expression_addition_littoral(const expression_addition_littoral &);

    /**
      * The assignment operator.  Do not use.
      */
    expression_addition_littoral &operator=(
        const expression_addition_littoral &);
};
