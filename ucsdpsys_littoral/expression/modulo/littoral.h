...
/**
  * The expression_modulo_littoral class is used to represent code
  * generation for integer multiplication expressions.
  */
class expression_modulo_littoral:
    public expression_modulo
{
public:
    typedef boost::shared_ptr<expression_modulo_littoral> pointer;

    /**
      * The destructor.
      */
    virtual ~expression_modulo_littoral();

private:
    /**
      * The constructor.
      */
    expression_modulo_littoral(const expression::pointer &lhs,
...
private:
    ...
    /**
      ...
      */
    expression_modulo_littoral();

    /**
      * The copy constructor.  Do not use.
      */
    expression_modulo_littoral(const expression_modulo_littoral &);

    /**
      * The assignment operator.  Do not use.
      */
    expression_modulo_littoral &operator=(const expression_modulo_littoral &);
};
