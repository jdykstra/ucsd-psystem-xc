...
/**
  * The expression_scan_littoral class is used to represent the processing
  * necessary to littoral print the weird SCAN function call with the
  * embedded non-syntactic "=" or "<>" comparison.
  */
class expression_scan_littoral:
    public expression_scan
{
public:
    typedef boost::shared_ptr<expression_scan_littoral> pointer;

    /**
      * The destructor.
      */
    virtual ~expression_scan_littoral();
...
private:
    /**
      ...
      *     The translation context we are working within.
      */
    expression_scan_littoral(const expression::pointer &maxdisp, int mask,
        const expression::pointer &value, const expression::pointer &start,
        translator_littoral *littoral);
    ...
    /**
      ...
      */
    expression_scan_littoral(const expression_scan_littoral &rhs);
    ...
    /**
      ...
      */
    expression_scan_littoral &operator=(const expression_scan_littoral &rhs);
};
