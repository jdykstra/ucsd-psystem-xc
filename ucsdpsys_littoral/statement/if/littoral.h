...
/**
  * The statement_if_littoral class is used to represent littoral printing
  * an "if" statement.
  */
class statement_if_littoral:
    public statement_if
{
public:
    typedef boost::shared_ptr<statement_if_littoral> pointer;

    /**
      * The destructor.
      */
    virtual ~statement_if_littoral();

private:
    /**
      * The constructor.
      */
    statement_if_littoral(const expression::pointer &a_cond,
        const statement::pointer &a_thn,
        const statement::pointer &a_els, translator_littoral *cntxt);
...
private:
    /**
      * The littoral instance variable is used to remember where to semd
    ...
    /**
      ...
      */
    statement_if_littoral();

    /**
      * The copy constructor.
      */
    statement_if_littoral(const statement_if_littoral &);

    /**
      * The assignment operator.
      */
    statement_if_littoral &operator=(const statement_if_littoral &);
};
