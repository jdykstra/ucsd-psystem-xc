...
scope_temporary_compound_littoral::~scope_temporary_compound_littoral()
{
}
...
scope_temporary_compound_littoral::pointer
scope_temporary_compound_littoral::create(scope_stack &a_stk,
    translator_littoral *a_context)
{
    return pointer(new scope_temporary_compound_littoral(a_stk, a_context));
}


symbol::pointer
scope_temporary_compound_littoral::constant_factory(const variable_name &vname,
...
scope_temporary_compound_littoral::parameter_factory(const variable_name &,
...
symbol_variable::pointer
scope_temporary_compound_littoral::variable_factory(const variable_name &vname,
