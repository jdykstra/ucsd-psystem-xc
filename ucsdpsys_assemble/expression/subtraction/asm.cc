...
expression_subtraction_asm::~expression_subtraction_asm()
{
}
...
expression_subtraction_asm::pointer
expression_subtraction_asm::create(const expression::pointer &a_lhs,
    const expression::pointer &a_rhs)
{
    return pointer(new expression_subtraction_asm(a_lhs, a_rhs));
}


type::pointer
expression_subtraction_asm::get_type(void)
    const
{
...
expression::pointer
expression_subtraction_asm::optimize(void)
    const
{
...
expression::pointer
expression_subtraction_asm::clone(const location &locn)
    const
{
