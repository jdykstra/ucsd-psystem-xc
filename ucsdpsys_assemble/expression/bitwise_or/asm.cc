...
expression_bitwise_or_asm::~expression_bitwise_or_asm()
{
}
...
expression_bitwise_or_asm::pointer
expression_bitwise_or_asm::create(const expression::pointer &a_lhs,
    const expression::pointer &a_rhs, assembler *a_context)
{
    return pointer(new expression_bitwise_or_asm(a_lhs, a_rhs, a_context));
}


expression::pointer
expression_bitwise_or_asm::optimize(void)
    const
{
...
expression::pointer
expression_bitwise_or_asm::clone(const location &where)
    const
{
