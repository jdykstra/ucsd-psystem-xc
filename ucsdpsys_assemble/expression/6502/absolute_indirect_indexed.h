...
#ifndef UCSDPSYS_ASSEMBLE_EXPRESSION_6502_ABSOLUTE_INDIRECT_INDEXED_H
#define UCSDPSYS_ASSEMBLE_EXPRESSION_6502_ABSOLUTE_INDIRECT_INDEXED_H

#include <ucsdpsys_assemble/expression/6502.h>

/**
  * The expression_6502_absolute_indirect_indexed class is used to
  * represent the absolute (or zero page) indirect indexed addressing
  * mode of the 6502.
  */
class expression_6502_absolute_indirect_indexed:
    public expression_6502
{
public:
    typedef boost::shared_ptr<expression_6502_absolute_indirect_indexed>
        pointer;

    /**
      * The destructor.
      */
    virtual ~expression_6502_absolute_indirect_indexed();
...
private:
    ...
    /**
      ...
      */
    expression_6502_absolute_indirect_indexed(
        const expression_6502_absolute_indirect_indexed &rhs);
    ...
    /**
      ...
      */
    expression_6502_absolute_indirect_indexed &operator=(
        const expression_6502_absolute_indirect_indexed &rhs);
};

#endif // UCSDPSYS_ASSEMBLE_EXPRESSION_6502_ABSOLUTE_INDIRECT_INDEXED_H
