...
#ifndef UCSDPSYS_ASSEMBLE_TYPE_SPECIAL_H
#define UCSDPSYS_ASSEMBLE_TYPE_SPECIAL_H

#include <lib/type.h>

/**
  * The type_special class is used to represent a special expression,
  * typically a register name.
  */
class type_special:
    public type
{
public:
    typedef boost::shared_ptr<type_special> pointer;

    /**
      * The destructor.
      */
    virtual ~type_special();
...
private:
    ...
    /**
      ...
      */
    type_special(const type_special &rhs);
    ...
    /**
      ...
      */
    type_special &operator=(const type_special &rhs);
};

#endif // UCSDPSYS_ASSEMBLE_TYPE_SPECIAL_H
