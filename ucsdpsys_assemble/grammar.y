...
/*
 *  N.B:  The makefile post-processes the parser source file generated by 
 *        bison to rename all bison-private identifiers (those prefixed
 *        by "yy" or "YY").  It does this to avoid conflicts between the
 *        multiple parsers in the package.
 */
