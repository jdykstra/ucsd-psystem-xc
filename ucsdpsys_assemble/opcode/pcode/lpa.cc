...
opcode_pcode_lpa::~opcode_pcode_lpa()
{
}


opcode_pcode_lpa::opcode_pcode_lpa(assembler *a_context) :
    opcode_pcode(a_context)
{
}


opcode_pcode_lpa::pointer
opcode_pcode_lpa::create(assembler *a_context)
{
    return pointer(new opcode_pcode_lpa(a_context));
}


void
opcode_pcode_lpa::interpret(const expression_list &args)
{
    if (args.empty())
    {
...
rcstring
opcode_pcode_lpa::get_name(void)
    const
{
    return "lpa";
}
