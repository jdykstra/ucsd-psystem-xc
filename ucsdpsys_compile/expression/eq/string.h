...
#ifndef UCSDPSYS_COMPILE_EXPRESSION_EQ_STRING_H
#define UCSDPSYS_COMPILE_EXPRESSION_EQ_STRING_H
...
/**
  * The expression_eq_string class is used to represent code
  * generation for string equal to expressions.
  */
...
private:
    ...
    /**
      ...
      */
    expression_eq_string &operator=(const expression_eq_string &);
};

#endif // UCSDPSYS_COMPILE_EXPRESSION_EQ_STRING_H
