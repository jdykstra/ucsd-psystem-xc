...
#ifndef UCSDPSYS_COMPILE_EXPRESSION_ADDRESS_GLOBREF_H
#define UCSDPSYS_COMPILE_EXPRESSION_ADDRESS_GLOBREF_H
...
/**
  * The expression_address_globref class is used to represent
  * the address of a not-linked-yet global variable.
  */
class expression_address_globref:
    public expression_address
{
public:
    typedef boost::shared_ptr<expression_address_globref> pointer;

    /**
      * The destructor.
      */
    virtual ~expression_address_globref();
...
private:
    /**
      ...
      *     The translation context we are working within.
      */
    expression_address_globref(const location &locn, const type::pointer &type,
        const symbol::pointer &sym, translator_compile *context);
    ...
    /**
      ...
      */
    expression_address_globref(const expression_address_globref &rhs);
    ...
    /**
      ...
      */
    expression_address_globref &operator=(
        const expression_address_globref &rhs);
};

#endif // UCSDPSYS_COMPILE_EXPRESSION_ADDRESS_GLOBREF_H
