...
#ifndef UCSDPSYS_COMPILE_EXPRESSION_ADDRESS_GLOBAL_H
#define UCSDPSYS_COMPILE_EXPRESSION_ADDRESS_GLOBAL_H
...
/**
  * The expression_address_global class is used to represent a global
  * (program's stack frame) address constant.
  */
class expression_address_global:
    public expression_address
{
public:
    typedef boost::shared_ptr<expression_address_global> pointer;
...
private:
    /**
      ...
      * @param offset
      *     The word offset into the global stack frame
      * @param type
      ...
      */
    expression_address_global(const location &locn, int offset,
...
#endif // UCSDPSYS_COMPILE_EXPRESSION_ADDRESS_GLOBAL_H
