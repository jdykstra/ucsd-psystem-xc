...
expression_integer_division_long_integer::pointer
expression_integer_division_long_integer::create(
    ...
    translator_compile *a_code)
{
    ...
    return
        pointer(new expression_integer_division_long_integer(e1, e2, a_code));
}


expression::pointer
expression_integer_division_long_integer::optimize(void)
    const
{
...
expression::pointer
expression_integer_division_long_integer::clone(const location &locn)
    const
{
...
void
expression_integer_division_long_integer::post_order_traversal(int)
    const
{
    code.breakpoint(get_location());
    code.emit_ldci(DECOPS_DIVIDE);
    code.emit_byte(CXP);
