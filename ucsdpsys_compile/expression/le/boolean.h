...
#ifndef UCSDPSYS_COMPILE_EXPRESSION_LE_BOOLEAN_H
#define UCSDPSYS_COMPILE_EXPRESSION_LE_BOOLEAN_H
...
/**
  * The expression_le_boolean class is used to represent code
...
private:
    ...
    /**
      ...
      */
    expression_le_boolean();

    /**
      * The copy constructor.  Do not use.
      */
    expression_le_boolean(const expression_le_boolean &);

    /**
      * The assignment operator.  Do not use.
      */
    expression_le_boolean &operator=(const expression_le_boolean &);
};

#endif // UCSDPSYS_COMPILE_EXPRESSION_LE_BOOLEAN_H
