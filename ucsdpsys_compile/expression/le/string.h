...
#ifndef UCSDPSYS_COMPILE_EXPRESSION_LE_STRING_H
#define UCSDPSYS_COMPILE_EXPRESSION_LE_STRING_H
...
/**
  * The expression_le_string class is used to represent code
...
private:
    ...
    /**
      ...
      */
    expression_le_string(const expression_le_string &);

    /**
      * The assignment operator.  Do not use.
      */
    expression_le_string &operator=(const expression_le_string &);
};

#endif // UCSDPSYS_COMPILE_EXPRESSION_LE_STRING_H
