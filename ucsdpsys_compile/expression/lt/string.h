...
#ifndef UCSDPSYS_COMPILE_EXPRESSION_LT_STRING_H
#define UCSDPSYS_COMPILE_EXPRESSION_LT_STRING_H
...
/**
  * The expression_lt_string class is used to represent code
...
private:
    ...
    /**
      ...
      */
    expression_lt_string(const expression_lt_string &);

    /**
      * The assignment operator.  Do not use.
      */
    expression_lt_string &operator=(const expression_lt_string &);
};

#endif // UCSDPSYS_COMPILE_EXPRESSION_LT_STRING_H
