...
symbol_function_sqrt::~symbol_function_sqrt()
{
}


symbol_function_sqrt::symbol_function_sqrt(translator_compile *cntxt) :
    symbol_function("sqrt", location::builtin(), scope::pointer(), -1),
    code(*cntxt)
{
    //
...
symbol_function_sqrt::pointer
symbol_function_sqrt::create(translator_compile *cntxt)
{
    return pointer(new symbol_function_sqrt(cntxt));
}


expression::pointer
symbol_function_sqrt::function_call_expression_factory(
    const expression_list &rhs) const
{
    ...
    //
    return expression_function_call_sqrt::create(rhs2.tail(), &code);
}


expression::pointer
symbol_function_sqrt::name_expression_factory(const symbol::pointer &sym,
