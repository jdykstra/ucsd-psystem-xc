...
symbol_function_blockwrite::~symbol_function_blockwrite()
{
...
symbol_function_blockwrite::symbol_function_blockwrite(
    ...
    symbol_function("blockwrite", location::builtin(), scope::pointer(), -1),
    code(*cntxt)
{
    DEBUG(1, "%s", __PRETTY_FUNCTION__);
    //
    // function blockwrite(f: file; var a; nblocks: integer): integer;
    // function blockwrite(f: file; var a; nblocks: integer;
...
symbol_function_blockwrite::pointer
symbol_function_blockwrite::create(translator_compile *cntxt)
{
    DEBUG(1, "%s", __PRETTY_FUNCTION__);
    return pointer(new symbol_function_blockwrite(cntxt));
}


expression::pointer
symbol_function_blockwrite::function_call_expression_factory(
...
expression::pointer
symbol_function_blockwrite::name_expression_factory(const symbol::pointer &sym,
