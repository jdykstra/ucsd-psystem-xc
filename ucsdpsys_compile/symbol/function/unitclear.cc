...
symbol_function_unitclear::~symbol_function_unitclear()
{
}
...
symbol_function_unitclear::symbol_function_unitclear(
    ...
    symbol_function("unitclear", location::builtin(), scope::pointer(), -1),
    code(*cntxt)
{
    //
...
symbol_function_unitclear::pointer
symbol_function_unitclear::create(translator_compile *cntxt)
{
    return pointer(new symbol_function_unitclear(cntxt));
}


expression::pointer
symbol_function_unitclear::function_call_expression_factory(
    const expression_list &rhs) const
{
    ...
    //
    return expression_function_call_unitclear::create(rhs2.tail(), &code);
}


expression::pointer
symbol_function_unitclear::name_expression_factory(const symbol::pointer &sym,
