...
symbol_function_ln::~symbol_function_ln()
{
}


symbol_function_ln::symbol_function_ln(translator_compile *cntxt) :
    symbol_function("ln", location::builtin(), scope::pointer(), -1),
    code(*cntxt)
{
    //
...
symbol_function_ln::pointer
symbol_function_ln::create(translator_compile *cntxt)
{
    return pointer(new symbol_function_ln(cntxt));
}


expression::pointer
symbol_function_ln::function_call_expression_factory(
    const expression_list &rhs) const
{
    ...
    //
    return expression_function_call_ln::create(rhs2.tail(), &code);
}


expression::pointer
symbol_function_ln::name_expression_factory(const symbol::pointer &sym,
