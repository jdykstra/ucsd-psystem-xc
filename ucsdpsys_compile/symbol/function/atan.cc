...
symbol_function_atan::~symbol_function_atan()
{
}
...
symbol_function_atan::symbol_function_atan(
    ...
    code(*cntxt)
{
    assert(a_name == "atan" || a_name == "arctan");

    //
    // function atan(theta: real): real;
    //
...
symbol_function_atan::pointer
symbol_function_atan::create(const rcstring &a_name, translator_compile *cntxt)
{
    return pointer(new symbol_function_atan(a_name, cntxt));
}


expression::pointer
symbol_function_atan::function_call_expression_factory(
    const expression_list &rhs) const
{
    ...
    //
    return expression_function_call_atan::create(rhs2.tail(), &code);
}


expression::pointer
symbol_function_atan::name_expression_factory(const symbol::pointer &sym,
