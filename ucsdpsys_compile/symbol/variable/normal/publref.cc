...
symbol_variable_normal_publref::~symbol_variable_normal_publref()
{
...
symbol_variable_normal_publref::pointer
symbol_variable_normal_publref::create(const variable_name &a_name,
    const type::pointer &a_tp, translator_compile *a_context)
{
    return pointer(new symbol_variable_normal_publref(a_name, a_tp, a_context));
}


expression::pointer
symbol_variable_normal_publref::name_expression_factory(
    const symbol::pointer &sp, const location &where, int)
{
    ...
    if (type_reference::is_a(tp))
    {
        ...
        addr =
            ...
            (
                expression_address_publref::create
                (
                    where,
