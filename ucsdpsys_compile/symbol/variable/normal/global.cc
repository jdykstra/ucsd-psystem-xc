...
symbol_variable_normal_global::~symbol_variable_normal_global()
{
    DEBUG(1, "%s\n", __PRETTY_FUNCTION__);
}
...
symbol_variable_normal_global::pointer
symbol_variable_normal_global::create(const variable_name &a_name,
    ...
    translator_compile *a_context)
{
    ...
    return
        pointer
        (
            new symbol_variable_normal_global
            (
                a_name,
                a_tp,
                a_lex_level,
...
expression::pointer
symbol_variable_normal_global::name_expression_factory(
