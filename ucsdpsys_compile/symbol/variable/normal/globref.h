...
#ifndef UCSDPSYS_COMPILE_SYMBOL_VARIABLE_NORMAL_GLOBREF_H
#define UCSDPSYS_COMPILE_SYMBOL_VARIABLE_NORMAL_GLOBREF_H
...
/**
  * The symbol_variable_normal_globref class is used to represent a
  ...
  * final executable.
  */
class symbol_variable_normal_globref:
    public symbol_variable_normal
{
public:
    typedef boost::shared_ptr<symbol_variable_normal_globref> pointer;

    /**
      * The destructor.
      */
    virtual ~symbol_variable_normal_globref();
...
private:
    /**
      ...
      *     The translation context we are working within.
      */
    symbol_variable_normal_globref(const variable_name &name,
    ...
    /**
      ...
      */
    symbol_variable_normal_globref();
    ...
    /**
      ...
      */
    symbol_variable_normal_globref(const symbol_variable_normal_globref &rhs);
    ...
    /**
      ...
      */
    symbol_variable_normal_globref &operator=(
        const symbol_variable_normal_globref &rhs);
};

#endif // UCSDPSYS_COMPILE_SYMBOL_VARIABLE_NORMAL_GLOBREF_H
