...
/**
  * The expression_function_call_pretty class is used to represent
  */
class expression_function_call_pretty:
    public expression_function_call
{
public:
    typedef boost::shared_ptr<expression_function_call_pretty> pointer;
...
private:
    /**
      * The constructor.
      */
    expression_function_call_pretty(const expression_list &args,
...
private:
    ...
    /**
      ...
      */
    expression_function_call_pretty &operator=(
        const expression_function_call_pretty &);
};
