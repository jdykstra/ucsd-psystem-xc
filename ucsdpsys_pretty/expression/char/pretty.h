...
/**
  * The expression_char_pretty class is used to represent pretty
  * printing a constant charater.
  */
class expression_char_pretty:
    public expression_char
{
public:
    typedef boost::shared_ptr<expression_char_pretty> pointer;
...
private:
    /**
      * The constructor.
      */
    expression_char_pretty(const location &locn, unsigned char value,
