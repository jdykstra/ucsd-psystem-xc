...
/**
  * The expression_in_pretty class is used to represent the processing
  * necessary to pretty print an IN expression.
  */
class expression_in_pretty:
    public expression_in
{
public:
    typedef boost::shared_ptr<expression_in_pretty> pointer;

    /**
      * The destructor.
      */
    virtual ~expression_in_pretty();
...
private:
    /**
      ...
      */
    expression_in_pretty(const expression::pointer &lhs,
        const expression::pointer &rhs, translator_pretty *pretty);
...
private:
    ...
    /**
      ...
      */
    expression_in_pretty(const expression_in_pretty &rhs);
    ...
    /**
      ...
      */
    expression_in_pretty &operator=(const expression_in_pretty &rhs);
};
