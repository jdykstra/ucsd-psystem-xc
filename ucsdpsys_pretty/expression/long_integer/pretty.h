...
/**
  * The expression_long_integer_pretty class is used to represent the
  * prcessing needed to pretty-print a long integer constant.
  */
class expression_long_integer_pretty:
    public expression_long_integer
{
public:
    typedef boost::shared_ptr<expression_long_integer_pretty> pointer;

    /**
      * The destructor.
      */
    virtual ~expression_long_integer_pretty();
...
private:
    /**
      ...
      *     The translation context we are working within.
      */
    expression_long_integer_pretty(const location &locn,
        const rcstring &value, translator_pretty *pretty);
    ...
    /**
      ...
      */
    expression_long_integer_pretty();
    ...
    /**
      ...
      */
    expression_long_integer_pretty(const expression_long_integer_pretty &rhs);
    ...
    /**
      ...
      */
    expression_long_integer_pretty &operator=(
        const expression_long_integer_pretty &rhs);
};
