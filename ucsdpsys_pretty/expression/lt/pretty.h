...
/**
  * The expression_lt_pretty class is used to represent the pretty
  * printing of an lt expression node.
  */
class expression_lt_pretty:
    public expression_lt
{
public:
    typedef boost::shared_ptr<expression_lt_pretty> pointer;

    /**
      * The destructor.
      */
    virtual ~expression_lt_pretty();

private:
    /**
      * The constructor.
      */
    expression_lt_pretty(const expression::pointer &lhs,
...
private:
    ...
    /**
      ...
      */
    expression_lt_pretty();

    /**
      * The copy constructor.  Do not use.
      */
    expression_lt_pretty(const expression_lt_pretty &);

    /**
      * The assignment operator.  Do not use.
      */
    expression_lt_pretty &operator=(const expression_lt_pretty &);
};
