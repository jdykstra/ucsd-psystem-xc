...
/**
  * The expression_integer_division_pretty class is used to represent the
  * pretty printing of an integer_division expression node.
  */
class expression_integer_division_pretty:
    public expression_integer_division
{
public:
    typedef boost::shared_ptr<expression_integer_division_pretty> pointer;

    /**
      * The destructor.
      */
    virtual ~expression_integer_division_pretty();

private:
    /**
      * The constructor.
      */
    expression_integer_division_pretty(const expression::pointer &lhs,
...
private:
    ...
    /**
      ...
      */
    expression_integer_division_pretty();

    /**
      * The copy constructor.  Do not use.
      */
    expression_integer_division_pretty(
        const expression_integer_division_pretty &);

    /**
      * The assignment operator.  Do not use.
      */
    expression_integer_division_pretty &operator=(
        const expression_integer_division_pretty &);
};
