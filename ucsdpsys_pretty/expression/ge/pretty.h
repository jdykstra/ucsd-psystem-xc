...
/**
  * The expression_ge_pretty class is used to represent the pretty
  * printing of an ge expression node.
  */
class expression_ge_pretty:
    public expression_ge
{
public:
    typedef boost::shared_ptr<expression_ge_pretty> pointer;

    /**
      * The destructor.
      */
    virtual ~expression_ge_pretty();

private:
    /**
      * The constructor.
      */
    expression_ge_pretty(const expression::pointer &lhs,
...
private:
    ...
    /**
      ...
      */
    expression_ge_pretty();

    /**
      * The copy constructor.  Do not use.
      */
    expression_ge_pretty(const expression_ge_pretty &);

    /**
      * The assignment operator.  Do not use.
      */
    expression_ge_pretty &operator=(const expression_ge_pretty &);
};
