...
scope_temporary_compound_pretty::~scope_temporary_compound_pretty()
{
}
...
scope_temporary_compound_pretty::pointer
scope_temporary_compound_pretty::create(scope_stack &a_stk,
    translator_pretty *a_context)
{
    return pointer(new scope_temporary_compound_pretty(a_stk, a_context));
}


symbol::pointer
scope_temporary_compound_pretty::constant_factory(const variable_name &vname,
...
scope_temporary_compound_pretty::parameter_factory(const variable_name &,
...
symbol_variable::pointer
scope_temporary_compound_pretty::variable_factory(const variable_name &vname,
