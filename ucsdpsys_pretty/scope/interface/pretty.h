...
/**
  * The scope_interface_pretty class is used to represent the whole
  * lot of nothing that the pretty printer does with unit interface
  * definitions.
  */
class scope_interface_pretty:
    public scope_interface
{
public:
    typedef boost::shared_ptr<scope_interface_pretty> pointer;

    /**
      * The destructor.
      */
    virtual ~scope_interface_pretty();
    ...
    /**
      ...
      */
    static pointer create(const rcstring &name, translator_pretty *context);
...
private:
    /**
      ...
      *     The translation context we are working within.
      */
    scope_interface_pretty(const rcstring &name, translator_pretty *context);
    ...
    /**
      ...
      */
    scope_interface_pretty(const scope_interface_pretty &rhs);
    ...
    /**
      ...
      */
    scope_interface_pretty &operator=(const scope_interface_pretty &rhs);
};
