...
/**
  * The scope_program_pretty class is used to represent a pretty prining
  * of the outer-most program scope.
  */
class scope_program_pretty:
    public scope_program
{
public:
    typedef boost::shared_ptr<scope_program_pretty> pointer;

    /**
      * The destructor.
      */
    virtual ~scope_program_pretty();

    /**
      * The create class method is used to create dynamically allocated
      * instances of this class.
      */
    static pointer create(const rcstring &name, translator_pretty *cntxt);
...
private:
    /**
      * The constructor.
      */
    scope_program_pretty(const rcstring &name, translator_pretty *cntxt);
    ...
    /**
      ...
      */
    scope_program_pretty();

    /**
      * The copy constructor.  Do not use.
      */
    scope_program_pretty(const scope_program_pretty &);

    /**
      * The assignment operator.  Do not use.
      */
    scope_program_pretty &operator=(const scope_program_pretty &);
};
