...
/**
  * The translator_pretty class is used to represent a pretty printer
  * for UCSD Pascal.
  */
class translator_pretty:
    public translator
{
public:
    /**
...
protected:
    ...
    // See base class for docuemntation.
    expression::pointer implicit_dot_expression(const expression::pointer &lhs,
...
public:
    /**
      * The print_token method is used to pretty print an output token.
...
private:
    ...
    /**
      ...
      * comprise the current line being pretty printed.
      */
    rcstring_list line;
    ...
    /**
      ...
      */
    translator_pretty &operator=(const translator_pretty &);
};
