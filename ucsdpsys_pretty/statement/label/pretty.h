...
/**
  * The statement_label_pretty class is used to represent the prcessing
  * required to pretty print a label statement.
  */
class statement_label_pretty:
    public statement_label
{
public:
    typedef boost::shared_ptr<statement_label_pretty> pointer;

    /**
      * The destructor.
      */
    virtual ~statement_label_pretty();
...
private:
    /**
      ...
      */
    statement_label_pretty(const symbol::pointer &sym,
...
private:
    ...
    /**
      ...
      */
    statement_label_pretty(const statement_label_pretty &rhs);
    ...
    /**
      ...
      */
    statement_label_pretty &operator=(const statement_label_pretty &rhs);
};
