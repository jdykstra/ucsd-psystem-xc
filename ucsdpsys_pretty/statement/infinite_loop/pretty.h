...
/**
  * The statement_infinite_loop_pretty class is used to represent pretty
  * printing an infinite loop.
  */
class statement_infinite_loop_pretty:
    public statement_infinite_loop
{
public:
    typedef boost::shared_ptr<statement_infinite_loop_pretty> pointer;

    /**
      * The destructor.
      */
    virtual ~statement_infinite_loop_pretty();

private:
    /**
      * The constructor.
      */
    statement_infinite_loop_pretty(const statement::pointer &body,
...
private:
    ...
    /**
      ...
      */
    statement_infinite_loop_pretty();

    /**
      * The copy constructor.  Do not use.
      */
    statement_infinite_loop_pretty(const statement_infinite_loop_pretty &);

    /**
      * The assignment operator.  Do not use.
      */
    statement_infinite_loop_pretty &operator=(
        const statement_infinite_loop_pretty &);
};
