...
disassembler_pcode_i_3::~disassembler_pcode_i_3()
{
}
...
disassembler_pcode_i_3::pointer
disassembler_pcode_i_3::create(byte_sex_t a_byte_sex, dislabel &a_where,
...
void
disassembler_pcode_i_3::preprocess(const unsigned char *data,
...
static const opcode_info_t opcode_info[256] =
{
    ...
    { "LCA",  "Load Const strng Addr"  }, // 166
    { "LDO",  "LoaD glObal word"       }, // 167
    { "MOV",  "Move words"             }, // 168
    { "MVB",  "MoVe Bytes"             }, // 169
    ...
    { "S1P",  "cnvt array to string"   }, // 208
    { "IXB",  "IndeX Byte"             }, // 209
    { "BYT",  "cnvt word_p to byte_p"  }, // 210
...
unsigned
disassembler_pcode_i_3::disassemble_one_instruction(const unsigned char *data,
                ...
                case 0:
                    {
                        ...
                        // FIXME: check this against I.3 system sources
