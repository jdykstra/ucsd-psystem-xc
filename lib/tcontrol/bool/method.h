...
#ifndef LIB_TCONTROL_BOOL_METHOD_H
#define LIB_TCONTROL_BOOL_METHOD_H
...
/**
  ...
  */
template <class T>
class tcontrol_bool_method:
    public tcontrol_bool
{
public:
    typedef boost::shared_ptr<tcontrol_bool_method> pointer;
    ...
    {
        return pointer(new tcontrol_bool_method(a_object, a_method));
    }
...
private:
    ...
    /**
      ...
      */
    tcontrol_bool_method(T *a_object, method_t a_method) :
        object(a_object),
        method(a_method)
    {
    }
...
#endif // LIB_TCONTROL_BOOL_METHOD_H
