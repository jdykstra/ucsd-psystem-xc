...
#ifndef LIB_TCONTROL_BOOL_METHOD_NOT_H
#define LIB_TCONTROL_BOOL_METHOD_NOT_H

#include <lib/tcontrol/bool.h>

/**
  * The tcontrol_bool_method class is used to represent a control that
  * calls a method with a bool parameter.
  */
template <class T>
class tcontrol_bool_method_not:
    public tcontrol_bool
{
public:
    typedef boost::shared_ptr<tcontrol_bool_method_not> pointer;
    ...
    /**
      * The destructor.
      */
    virtual ~tcontrol_bool_method_not() { }
    ...
    {
        return pointer(new tcontrol_bool_method_not(a_object, a_method));
    }
...
protected:
    ...
    {
        (object->*method)(!check_value(args, true));
    }
...
private:
    ...
    /**
      ...
      */
    tcontrol_bool_method_not(T *a_object, method_t a_method) :
        object(a_object),
        method(a_method)
    {
    }
...
#endif // LIB_TCONTROL_BOOL_METHOD_NOT_H
