...
#ifndef LIB_EXPRESSION_REAL_DIVISION_H
#define LIB_EXPRESSION_REAL_DIVISION_H

#include <lib/expression.h>

/**
  * The expression_real_division class is used to represent an abstract
  * real_division expression node.
  */
class expression_real_division:
    public expression
{
public:
    /**
      * The destructor.
      */
    virtual ~expression_real_division();

    /**
      * The constructor.
      */
    expression_real_division(const expression::pointer &lhs,
...
protected:
    /**
      ...
      */
    expression_real_division(const expression_real_division &);

private:
    /**
      * The assignment operator.  Do not use.
      */
    expression_real_division &operator=(const expression_real_division &);
};

#endif // LIB_EXPRESSION_REAL_DIVISION_H
