...
#ifndef LIB_EXPRESSION_LOGICAL_OR_H
#define LIB_EXPRESSION_LOGICAL_OR_H
...
/**
  * The expression_logical_or class is used to represent an abstract
  * logical OR expression node.
  */
class expression_logical_or:
    public expression
{
public:
    /**
    ...
    /**
      * The constructor.
      */
    expression_logical_or(const expression::pointer &lhs,
...
#endif // LIB_EXPRESSION_LOGICAL_OR_H
