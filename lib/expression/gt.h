...
#ifndef LIB_EXPRESSION_GT_H
#define LIB_EXPRESSION_GT_H

#include <lib/expression.h>

/**
  * The expression_gt class is used to represent an abstract
  * greater-than comparison expression node.
  */
class expression_gt:
    public expression
{
...
protected:
    /**
      ...
      */
    expression_gt(const expression::pointer &lhs,
    ...
    /**
      * The get_lhs method may be use to ontain the left hand side of
      * the comparison.
      */
    expression::pointer get_lhs() const { return lhs; }

    /**
      * The get_rhs method may be use to ontain the right hand side of
      * the comparison.
      */
...
private:
    ...
    /**
      ...
      */
    expression_gt(const expression_gt &);

    /**
      * The assignment operator.  Do not use.
      */
    expression_gt &operator=(const expression_gt &);
};

#endif // LIB_EXPRESSION_GT_H
