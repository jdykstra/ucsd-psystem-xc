...
#ifndef LIB_EXPRESSION_BITWISE_OR_H
#define LIB_EXPRESSION_BITWISE_OR_H

#include <lib/expression.h>

/**
  * The expression_bitwise_or class is used to represent
  * a bit-wise (inclusive) OR expression.
  */
class expression_bitwise_or:
    public expression
{
public:
    typedef boost::shared_ptr<expression_bitwise_or> pointer;

    /**
      * The destructor.
      */
    virtual ~expression_bitwise_or();
...
protected:
    /**
      ...
      */
    expression_bitwise_or(const expression::pointer &lhs,
...
private:
    ...
    /**
      ...
      */
    expression_bitwise_or(const expression_bitwise_or &rhs);
    ...
    /**
      ...
      */
    expression_bitwise_or &operator=(const expression_bitwise_or &rhs);
};

#endif // LIB_EXPRESSION_BITWISE_OR_H
