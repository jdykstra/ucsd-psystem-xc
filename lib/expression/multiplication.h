...
#ifndef LIB_EXPRESSION_MULTIPLICATION_H
#define LIB_EXPRESSION_MULTIPLICATION_H

#include <lib/expression.h>

/**
  * The expression_multiplication class is used to represent an abstract
  * multiplication expression node.
  */
class expression_multiplication:
    public expression
{
public:
    /**
      * The destructor.
      */
    virtual ~expression_multiplication();
...
protected:
    /**
      ...
      */
    expression_multiplication(const expression::pointer &lhs,
...
private:
    ...
    /**
      ...
      */
    expression_multiplication(const expression_multiplication &);

    /**
      * The assignment operator.  Do not use.
      */
    expression_multiplication &operator=(const expression_multiplication &);
};

#endif // LIB_EXPRESSION_MULTIPLICATION_H
