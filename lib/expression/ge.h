...
#ifndef LIB_EXPRESSION_GE_H
#define LIB_EXPRESSION_GE_H

#include <lib/expression.h>

/**
  * The expression_ge class is used to represent an abstract
...
protected:
    /**
      ...
      *
      * @param lhs
      *     The left hand side of the compariosn.
      * @param rhs
      *     The right hand side of the compariosn.
      */
    expression_ge(const expression::pointer &lhs,
...
protected:
    /**
      ...
      * For use by derived classes only.
      */
    expression_ge(const expression_ge &);

private:
    /**
      * The assignment operator.  Do not use.
      */
    expression_ge &operator=(const expression_ge &);
};

#endif // LIB_EXPRESSION_GE_H
