...
#ifndef LIB_OUTPUT_WRAP_COOK_H
#define LIB_OUTPUT_WRAP_COOK_H

#include <lib/output.h>
#include <lib/rcstring/accumulator.h>

/**
  * The output_wrap_cook class is used to represent the processing
  * required to wrap the text of a cookbook as it is written.
  */
class output_wrap_cook:
    public output
{
public:
    typedef boost::shared_ptr<output_wrap_cook> pointer;

    /**
      * The destructor.
      */
    virtual ~output_wrap_cook();
...
private:
    /**
      ...
      *     wrapped.
      */
    output_wrap_cook(const output::pointer &deeper);
    ...
    /**
      ...
      */
    output_wrap_cook(const output_wrap_cook &rhs);
    ...
    /**
      ...
      */
    output_wrap_cook &operator=(const output_wrap_cook &rhs);
};

#endif // LIB_OUTPUT_WRAP_COOK_H
