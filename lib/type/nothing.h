...
#ifndef LIB_TYPE_NOTHING_H
#define LIB_TYPE_NOTHING_H

#include <lib/type.h>

/**
  * The type_nothing class is used to represent a type that matches
  ...
  *
  * Examples include
  *     file of nothing (i.e a raw file)
  *     function returning nothing (i.e. a procedure)
  */
class type_nothing:
    public type
{
public:
    typedef boost::shared_ptr<type_nothing> pointer;

    /**
      * The destructor.
      */
    virtual ~type_nothing();
...
private:
    ...
    /**
      ...
      */
    type_nothing(const type_nothing &rhs);
    ...
    /**
      ...
      */
    type_nothing &operator=(const type_nothing &rhs);
};

#endif // LIB_TYPE_NOTHING_H
